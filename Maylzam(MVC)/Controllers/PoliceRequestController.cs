...
namespace Maylzam_MVC_.Controllers
{
    ...
    {
        private readonly ITPRequestReposiyory repository;

        private readonly ICustomerRepository customerrepository;

        public PoliceRequestController(ITPRequestReposiyory repository, ICustomerRepository customerrepository)
        {
        ...
        public IActionResult Add(int id)
        {
            ...
            return View(new PoliceRequestVM { Id = id });
        }

        [HttpPost]
        public async Task<IActionResult> Add(PoliceRequestVM entity)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(TPRequest entity)
        {
            if (!ModelState.IsValid)
            {
                return View(entity);
